...
const ptDescription = 'A Megon ajuda pequenas empresas a transformar protótipos criados com IA em ferramentas internas prontas para o dia a dia.'
const enTitle = 'Megon | AI-built internal tools, ready for everyday use'
const enDescription = 'Megon helps small companies turn AI-built prototypes into internal tools that are ready for everyday use.'

const indexPath = new URL('../dist/index.html', import.meta.url)
const enDir = new URL('../dist/en/', import.meta.url)
const enPath = new URL('../dist/en/index.html', import.meta.url)

const ptHtml = await readFile(indexPath, 'utf8')
